...
class UserAccessController extends Controller
{
    ...
    public function create()
    {
        ...
        $displayNames = array(
            ...
            'Drivers' => 'Drivers',
            'Vehicles' => 'Fleet',
            'VehicleInspection' => 'Fleet Inspection',
            'ServiceReminders' => 'Preventive Maintenance',
            'ServiceItems' => 'Service Items',
            'ProductYields' => 'Yield Management',
        ...
        return view('roles.create', compact('modules', 'displayNames'));
    }
    ...
    public function store(Request $request)
    {
        $modules = array(
            ...
            'Vehicles', // Fleet
            'VehicleInspection', // Fleet Inspection
            'ProductYields', // Existing
            'CorrectiveMaintenance', // ServiceReminders Temporary Assigned
            'ServiceReminders', // Exisiting //Preventive Maintenance
            'ServiceItems', // Exisiting //Preventive Maintenance
            'Fuel', // Exisiting // Same for Fuel Allocation
            'Vendors', // Exisiting
            'WorkOrders', // Exisiting
            'Parts', // Manage Parts // Exisiting
            'PartsCategory', // Exisiting
            'Reports',
