...
class PreventiveMaintenanceLogs extends Model
{

    use SoftDeletes;
    protected $dates = ['deleted_at'];
    protected $table = "preventive_maintenance_logs";
    protected $fillable = ['vehicle_id', 'service_item_id', 'parts_id', 'quantity', 'price', 'deviation', 'last_date', 'last_meter', 'user_id'];
