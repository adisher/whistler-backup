  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        ...
        <a href="<?php echo e(route('company-services.create')); ?>" class="btn btn-success" title="<?php echo app('translator')->get('fleet.addNew'); ?>"><i class="fa fa-plus"></i></a></h3>
      </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/whistler/framework/resources/views/company_services/index.blade.php ENDPATH**/ ?>