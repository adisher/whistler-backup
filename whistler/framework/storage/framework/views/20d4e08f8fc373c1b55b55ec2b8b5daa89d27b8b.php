...
<li class="breadcrumb-item active"><?php echo app('translator')->get('fleet.user_report'); ?></li>
  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->get('fleet.user_report'); ?>
        </h3>
      </div>
        ...
        <div class="row">
          ...
          <div class="form-group" style="margin-right: 10px">
            ...
            <select id="user_id" name="user_id" class="form-control" required>
              <option value=""><?php echo app('translator')->get('fleet.selectUser'); ?></option>
          ...
          <button type="submit" formaction="<?php echo e(url('admin/print-users-report')); ?>" class="btn btn-danger"><i class="fa fa-print"></i> <?php echo app('translator')->get('fleet.print'); ?></button>
          <?php echo Form::close(); ?>
    ...
    <div class="card card-info">
      ...
      <div class="card-body table-responsive">
        <table class="table table-bordered table-striped table-hover"  id="myTable">
          <thead>
            <tr>
              <th><?php echo app('translator')->get('fleet.book_by'); ?></th>
              ...
              <th><?php echo app('translator')->get('fleet.journey_status'); ?></th>
            ...
            <tr>
              ...
              <td>
                <?php if($row->status == 1): ?>
                  ...
                  <?php echo app('translator')->get('fleet.completed'); ?>
                  </span>
                <?php else: ?>
                  <span class="text-warning">
                  <?php echo app('translator')->get('fleet.not_completed'); ?>
                  </span>
                <?php endif; ?>
              </td>
              <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/whistler/framework/resources/views/reports/users.blade.php ENDPATH**/ ?>