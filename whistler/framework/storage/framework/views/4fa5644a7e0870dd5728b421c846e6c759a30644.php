...
<li class="breadcrumb-item active"> <?php echo app('translator')->get('fleet.edit_vendor'); ?></li>
  ...
  <div class="col-md-12">
    <div class="card card-warning">
      <div class="card-header">
        <h3 class="card-title">
          <?php echo app('translator')->get('fleet.edit_vendor'); ?>
        </h3>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <?php echo Form::label('name',__('fleet.name'). ' <span class="text-danger">*</span>', ['class' => 'form-label'], false); ?>
          ...
          <div class="col-md-6">
            <div class="form-group">
              <?php echo Form::label('phone',__('fleet.phone'). ' <span class="text-danger">*</span>', ['class' => 'form-label'], false); ?>
          ...
          <div class="col-md-6">
            <div class="form-group">
              <?php echo Form::label('type', __('Vendor Type'). ' <span class="text-danger">*</span>', ['class' => 'form-label'], false); ?>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php echo Form::text('website',$data->website,['class'=>'form-control']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/whistler/framework/resources/views/vendors/edit.blade.php ENDPATH**/ ?>