        ...
        <div class="row">
          ...
          <div class="form-group" style="margin-right: 10px">
            ...
            <select id="vehicle_id" name="vehicle_id" class="form-control vehicles" style="width: 250px">
              ...
              <option value="<?php echo e($vehicle->id); ?>" <?php if($vehicle->id == $vehicle_select): ?> selected <?php endif; ?>><?php echo e($vehicle->maker_name); ?>-<?php echo e($vehicle->model_name); ?>-<?php echo e($vehicle->license_plate); ?></option>
              ...
              <table class="table table-bordered table-striped table-hover myTable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo e(Hyvikk::get("currency")); ?><?php echo e($exp->driver_amount??$exp->amount); ?></td>
                  </tr>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
              </table>
...
var chartData2 = {
  ...
  datasets: [{
      ...
      borderColor: window.chartColors.black,
      borderWidth: 1,
      data: [<?php $__currentLoopData = $income_by_cat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($exp->driver_amount??$exp->amount); ?>, <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>]
  }]
};
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/whistler/framework/resources/views/reports/monthly.blade.php ENDPATH**/ ?>