          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <select id="role_id" name="role_id" class="form-control" required>
                ...
                <option value="<?php echo e($role->id); ?>" <?php if($user->roles->first()->id == $role->id): ?> selected
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/whistler/framework/resources/views/users/edit.blade.php ENDPATH**/ ?>