...
<li class="breadcrumb-item active"><?php echo app('translator')->get('fleet.createGroup'); ?></li>
    ...
    <div class="col-md-12">
        <div class="card card-success">
            <div class="card-header">
                <h3 class="card-title"><?php echo app('translator')->get('fleet.createGroup'); ?></h3>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/whistler/framework/resources/views/vehicle_groups/create.blade.php ENDPATH**/ ?>