        ...
        <table class="table" id="data_table">
          ...
          <?php ($diff_in_days = $to->diffInDays($from)); ?>
            ...
            <tr>
              ...
              <td>
              <?php echo e($data->vehicle->year); ?> <?php echo e($data->vehicle->make_name); ?> <?php echo e($data->vehicle->model_name); ?>

              <br>
              <?php echo app('translator')->get('fleet.vin'); ?>:<?php echo e($data->vehicle->vin); ?>

              <br>
              <?php echo app('translator')->get('fleet.plate'); ?>:<?php echo e($data->vehicle->license_plate); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/whistler/framework/resources/views/notifications/service_reminder.blade.php ENDPATH**/ ?>