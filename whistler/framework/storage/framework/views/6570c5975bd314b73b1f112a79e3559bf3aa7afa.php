...
<div class="row">
	<div class="col-md-12">
		<div class="card card-info">
			...
			<div class="card-body">
				<?php echo Form::open(['route' => 'reports.fuel_report','method'=>'post','class'=>'form-inline']); ?>
				...
				<div class="row">
					...
					<div class="form-group" style="margin-right: 10px">
						...
						<select id="vehicle_id" name="vehicle_id" class="form-control vehicles" required style="width: 250px;">
							...
							<option value="<?php echo e($vehicle['id']); ?>" <?php if($vehicle['id']==$vehicle_id): ?> selected <?php endif; ?>><?php echo e($vehicle->make_name); ?>-<?php echo e($vehicle->model_name); ?>-<?php echo e($vehicle['license_plate']); ?></option>
				...
				<table class="table table-bordered table-striped table-hover"  id="myTable">
					...
					<?php $__currentLoopData = $fuel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
							...
							<td><?php echo e($f->vehicle_data->make_name); ?>-<?php echo e($f->vehicle_data->model_name); ?>-<?php echo e($f->vehicle_data->license_plate); ?></td>
							<td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/whistler/framework/resources/views/reports/fuel.blade.php ENDPATH**/ ?>