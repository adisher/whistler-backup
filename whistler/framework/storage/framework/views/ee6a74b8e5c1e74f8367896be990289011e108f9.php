...
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('products-yield.index')); ?>">Sites</a></li>
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="info-tab">
                            <?php echo Form::open([
                                'route' => ['products-yield.update', $products->id],
                                'files' => true,
                                'method' => 'PATCH',
                            ...
                            <?php echo Form::hidden('id', $products->id); ?>
                            ...
                            <div class="row card-body">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                <?php echo Form::label('site_name', __('fleet.site_name'). ' <span class="text-danger">*</span>', [
                                                    'class' => 'col-xs-5 control-label',
                                            ], false); ?>

                                                <div class="col-xs-6">
                                                    <?php echo Form::text('site_name', $products->site_name, ['class' => 'form-control', 'required']); ?>
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-6">
                                                    <?php echo Form::textarea('site_details', $products->site_details, ['class' => 'form-control', 'required']); ?>
                                            ...
                                            <div class="col-ms-6">
                                                <label class="switch">
                                                    <input type="checkbox" name="product_transfer" value="1"
                                                        <?php if($products->product_transfer == '1'): ?> checked <?php endif; ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/whistler/framework/resources/views/products_yield/edit.blade.php ENDPATH**/ ?>