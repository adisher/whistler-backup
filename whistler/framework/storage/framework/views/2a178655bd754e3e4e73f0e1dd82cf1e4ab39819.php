...
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('sites.index')); ?>">Site Shifts</a></li>
                        ...
                        <div class="tab-pane active" id="shifts-tab">
                            ...
                            <div class="row card-body">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <!-- Shift Name -->
                                    <div class="form-group">
                                        <?php echo Form::label('shift', __('Shift'), ['class' => 'col-xs-5 control-label']); ?>
                                    ...
                                    <!-- Shift Incharge -->
                                    <div class="form-group">
                                        <?php echo Form::label('shift_incharge_id', __('fleet.shift_incharge_id'), [
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                <?php echo Form::label('shift_details', __('fleet.shift_details'), [
                                                'class' => 'col-xs-5 control-label',
                                                ]); ?>

                                                <div class="col-xs-6">
                                                    <?php echo Form::textarea('shift_details', null, ['class' => 'form-control', 'required']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/whistler/framework/resources/views/shifts/create.blade.php ENDPATH**/ ?>