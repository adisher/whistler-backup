...
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('shift-details.index')); ?>">Yield Details</a></li>
                            ...
                            <div class="row card-body">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-6">
                                            <?php echo Form::number('shift_quantity_grams', null, ['class' => 'form-control', 'required']); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-6">
                                            <?php echo Form::number('shift_quantity_pounds', null, ['class' => 'form-control', 'readonly']); ?>

                                        </div>
                                    </div>
                                    <!-- Shift Yield Quantity(kgs) -->
                                    <div class="form-group">
                                        <?php echo Form::label('shift_quantity_kgs', __('fleet.shift_quantity') . '(' . __('kgs') . ')', [
                                        'class' => 'col-xs-5 control-label',
                                        ]); ?>

                                        <div class="col-xs-6">
                                            <?php echo Form::number('shift_quantity_kgs', null, ['class' => 'form-control', 'readonly']); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-6">
                                            <?php echo Form::number('yield_quality', null, ['class' => 'form-control', 'required']); ?>
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-6">
                                                    <?php echo Form::text('wastage', null, ['class' => 'form-control']); ?>
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-6">
                                                    <?php echo Form::text('net_weight_grams', null, ['class' => 'form-control', 'readonly']); ?>
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-6">
                                                    <?php echo Form::text('net_weight_pounds', null, ['class' => 'form-control', 'readonly']); ?>
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                <?php echo Form::label('net_weight_kgs', __('Net Weight') . '(' . __('kgs') . ')', [
                                                    'class' => 'col-xs-5 control-label',
                                                ]); ?>

                                                <div class="col-xs-6">
                                                    <?php echo Form::text('net_weight_kgs', null, ['class' => 'form-control', 'readonly']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/whistler/framework/resources/views/shift_details/create.blade.php ENDPATH**/ ?>