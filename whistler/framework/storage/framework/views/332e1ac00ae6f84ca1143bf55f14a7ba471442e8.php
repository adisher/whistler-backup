        ...
        <div class="col-md-12">
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title"><?php echo app('translator')->get('menu.manageParts'); ?>&nbsp
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Parts add')): ?>
                            <a href="<?php echo e(route('parts.create')); ?>" class="btn btn-success"><i class="fa fa-plus"></i></a>
                        <?php endif; ?>
                    </h3>
                </div>
                            ...
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <img src="<?php echo e(asset('assets/images/no-image.png')); ?>" height="50px"
                                                width="50px">
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <!-- Add Stock Button -->
                                            <a class="btn btn-success mr-2" data-id="<?php echo e($row->id); ?>"
                                                data-toggle="modal" data-target="#stockModal"
                                                data-title="<?php echo e($row->title); ?>" data-toggle="tooltip" title="Add Stock">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu custom" role="menu">
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Parts edit')): ?>
                                                        <a class="dropdown-item"
                                                            href="<?php echo e(url('admin/parts/' . $row->id . '/edit')); ?>">
                                                            <span aria-hidden="true" class="fa fa-edit"
                                                                style="color: #f0ad4e;"></span> <?php echo app('translator')->get('fleet.edit'); ?>
                                                        </a>
                                                    <?php endif; ?>
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Parts delete')): ?>
                                                        <a class="dropdown-item" data-id="<?php echo e($row->id); ?>"
                                                            data-toggle="modal" data-target="#myModal">
                                                            <span aria-hidden="true" class="fa fa-trash"
                                                                style="color: #dd4b39"></span> <?php echo app('translator')->get('fleet.delete'); ?>
                                                        </a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
