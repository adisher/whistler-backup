  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">Fleet &nbsp;
          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Vehicles add')): ?><a href="<?php echo e(route('vehicle-types.create')); ?>" class="btn btn-success" title="<?php echo app('translator')->get('fleet.addNew'); ?>"><i class="fa fa-plus"></i></a></h3><?php endif; ?>
      </div>
        ...
        <table class="table" id="ajax_data_table">
          <thead class="thead-inverse">
            <tr>
              ...
              <th>Fuel Capacity (Ltr)</th>
              <th>Oil Capacity (Ltr)</th>
              <th>Status</th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/whistler/framework/resources/views/vehicle_types/index.blade.php ENDPATH**/ ?>