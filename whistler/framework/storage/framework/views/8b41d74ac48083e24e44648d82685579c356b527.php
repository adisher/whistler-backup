    ...
    <div class="col-md-12">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Manage Yield Details &nbsp; <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ProductYields add')): ?>
                    <a href="<?php echo e(route('shift-details.create')); ?>" class="btn btn-success"
                        title="<?php echo app('translator')->get('fleet.addNew'); ?>"><i class="fa fa-plus"></i></a>
                    <?php endif; ?>
    ...
    $("#del_btn").on("click", function() {
        ...
        $(function() {
            ...
            var table = $('#ajax_data_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(url('admin/shift-details-fetch')); ?>",
                    type: 'POST',
                    data: {}
                },
                columns: [{
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/whistler/framework/resources/views/shift_details/index.blade.php ENDPATH**/ ?>