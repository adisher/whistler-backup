        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <?php echo Form::label('first_name', __('fleet.firstname'). ' <span class="text-danger">*</span>', ['class' => 'form-label'], false); ?>
            ...
            <div class="form-group">
              <?php echo Form::label('last_name', __('fleet.lastname'). ' <span class="text-danger">*</span>', ['class' => 'form-label'], false); ?>
            ...
            <div class="form-group">
              <?php echo Form::label('role_id',__('fleet.role'). ' <span class="text-danger">*</span>', ['class' => 'form-label'], false); ?>
          ...
          <div class="col-md-6">
            <div class="form-group">
              <?php echo Form::label('email', __('fleet.email'). ' <span class="text-danger">*</span>', ['class' => 'form-label'], false); ?>
            ...
            <div class="form-group">
              <?php echo Form::label('password', __('fleet.password'). ' <span class="text-danger">*</span>', ['class' => 'form-label'], false); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/whistler/framework/resources/views/users/create.blade.php ENDPATH**/ ?>