        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              {!! Form::label('name',__('fleet.name'). ' <span class="text-danger">*</span>', ['class' => 'form-label'], false) !!}
          ...
          <div class="col-md-6">
            <div class="form-group">
              {!! Form::label('phone',__('fleet.phone'). ' <span class="text-danger">*</span>', ['class' => 'form-label'], false) !!}
          ...
          <div class="col-md-6">
            <div class="form-group">
              {!! Form::label('type', __('Vendor Type'). ' <span class="text-danger">*</span>', ['class' => 'form-label'], false) !!}
