        ...
        <div class="col-md-12">
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">Manage Sites &nbsp; @can('ProductYields add')
                            <a href="{{ route('sites.create') }}" class="btn btn-success" title="@lang('fleet.addNew')"><i
                ...
                <div class="card-body table-responsive">
                    <table class="table" id="ajax_data_table" style="padding-bottom: 25px">
                        ...
                        <tfoot>
                            <tr>
                                <th>
                                    @can('ProductYields delete')<button class="btn btn-danger" id="bulk_delete"
                                            data-toggle="modal" title="@lang('fleet.delete')" data-target="#bulkModal"
                                            disabled><i class="fa fa-trash"></i></button>@endcan
                                <th>#</th>
                                <th>@lang('fleet.site_name')</th>
                                <th>@lang('fleet.site_details')</th>
                                {{-- <th>Site Production Details</th> --}}
