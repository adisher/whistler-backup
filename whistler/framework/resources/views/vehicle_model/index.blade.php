    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">Fleet Model &nbsp;
          @can('VehicleType add')<a href="{{ route('vehicle-model.create')}}" class="btn btn-success" title="@lang('fleet.addNew')"><i class="fa fa-plus"></i></a></h3>@endcan
      </div>
...
<script type="text/javascript">
  ...
  $(function(){
    ...
    var table = $('#ajax_data_table').DataTable({
         ...
         serverSide: true,
         ajax: {
          url: "{{ url('admin/vehicle-model-fetch') }}",
          type: 'POST',
          data:{}
         },
         columns: [
