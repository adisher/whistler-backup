        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body collapse show" id="fuel">
                    <div class="row">
                        <div class="col-md-12">
                            {{-- <p class="text-center"><strong>Transactions: @if (count($dk) > 0)
                                    {{ $dk[0] }} - {{ end($dk) }}
                                    @endif
                                </strong></p> --}}
                            <div class="chart">
                                ...
                                @php($height = '250')
                                @endif
                                <canvas id="datewise2" width="800" height="{{ $height }}"></canvas>
        ...
        <div class="col-md-6">
            <div class="card card-default">
                ...
                <div class="card-body collapse show" id="purchase">
                    ...
                    @php($height = '300')
                    @endif
                    <div class="chart"><canvas id="purchases" width="800" height="{{ $height }}"></canvas> </div>
                </div>
            </div>
        </div>
    </div>
