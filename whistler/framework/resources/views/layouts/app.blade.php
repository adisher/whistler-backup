...
<body class="hold-transition {{ auth()->user()->theme }} layout-fixed  sidebar-mini" @if ($language=='Arabic-ar' )
    dir="rtl" @endif>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand">
            ...
            <a href="{{ url('admin/') }}" class="brand-link">
                <img src="{{ asset('assets/images/logo-whistler.png')}}" alt="Fleet Logo" class="brand-image">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="{{ url('admin/change-details/' . Auth::user()->id) }}" class="d-block">{{
                            Auth::user()->name }}</a>
                    </div>
                </div>
                <div class="form-inline">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar nav-flat flex-column" data-widget="treeview" role="menu"
                            ...
                            <li class="nav-item">
                                <a href="{{ url('admin/vehicle-inspection') }}" class="nav-link @if (Request::is('admin/vehicle-inspection*') ||
                            ...
                            <li class="nav-item has-treeview {{ $class }}">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ url('admin/vehicle-reviews') }}" class="nav-link 
                                                                    @if (Request::is('admin/vehicle-reviews*') ||
                                                                            Request::is('admin/view-vehicle-review*') ||
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('maintenance.index') }}"
                                            class="nav-link @if (Request::is('admin/maintenance*')) active @endif">
                            ...
                            @php($active = '')
                            @endif
                            @canany(['WorkOrders list', 'WorkOrders add'])
                            <li class="nav-item has-treeview {{ $class }}">
                                <a href="#" class="nav-link {{ $active }}">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    @can('WorkOrders list')
                                    <li class="nav-item">
                                        <a href="{{ route('work_order.index') }}" class="nav-link @if (
                            ...
                            <li class="nav-item has-treeview {{ $class }}">
                                ...
                                <ul class="nav nav-treeview">
                                    @can('Fuel add')
                                    <li class="nav-item">
                                        <a href="{{ route('fuel.add_fuel_form') }}"
                                            class="nav-link @if (Request::is('admin/fuel/fuel-form')) active @endif">
                                            <i class="fa fa-plus-square nav-icon"></i>
                                            <p>Add Fuel</p>
                                        </a>
                                    </li>
                                    ...
                                    @can('Fuel list')
                                    <li class="nav-item">
                                        <a href="{{ route('fuel.fuel_details') }}"
                                            class="nav-link @if (Request::is('admin/fuel/fuel-details')) active @endif">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{ route('sites.index') }}"
                                            class="nav-link @if (Request::is('admin/sites*')) active @endif" style="position:relative">
                                            <i class="fa fa-building nav-icon"></i>
                                            <p>Manage Sites</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('shifts.index') }}" class="nav-link @if (Request::is('admin/shifts*')) active @endif"
                                            style="position:relative">
                                            <i class="fa fa-truck nav-icon"></i>
                                            <p>Manage Shifts</p>
                                        </a>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('shift-details.index') }}"
                                            class="nav-link @if (Request::is('admin/shift-details*')) active @endif" style="position:relative">
                                            <i class="fa fa-truck nav-icon"></i>
                            ...
                            @php($active = '')
                            @endif
                            @canany(['Users list', 'Customer list', 'Settings list'])
                            <li class="nav-item has-treeview {{ $class }}">
                                <a href="#" class="nav-link {{ $active }}">
                            ...
                            <li class="nav-item has-treeview {{ $class }}">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ url('admin/reports/scheduled') }}"
                                            class="nav-link @if (Request::is('admin/reports/scheduled')) active @endif">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ url('admin/reports/generate') }}"
                                            class="nav-link @if (Request::is('admin/reports/generate')) active @endif">
                                            <i class="fa fa-money-bill-alt nav-icon"></i>
                                            <p>Create Report</p>
                                        </a>
                                    </li>
                                    {{-- <li class="nav-item">
                                        <a href="{{ route('reports.fleet') }}" class="nav-link @if (Request::is('admin/reports/fleet')) active @endif">
                                            <i class="fa fa-truck nav-icon"></i>
                                            <p>Fleet Report</p>
                                        </a>
                                    </li> --}}
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('reports.yield') }}"
                                            class="nav-link @if (Request::is('admin/reports/product-yield')) active @endif">
                                            <i class="fa fa-truck nav-icon"></i>
                                            <p>Product Yield Report</p>
                                        </a>
                                    </li>
