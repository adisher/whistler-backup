    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">
          ...
          &nbsp;
          @can('Fuel add')<a href="{{ route('fuel.add_fuel_form')}}" class="btn btn-success"  title="@lang('fleet.addNew')"><i class="fa fa-plus"></i></a>@endcan
        </h3>
      </div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                {{ $currency->symbol }}{{$row->cost_per_unit}}/ Ltr
                <br>
                <b>Total:</b> {{ $currency->symbol }}{{$total}}
              </td>
              <td>
                {{ $row->vendor->name  }}
              </td>
              <td>
                <div class="btn-group">
                  ...
                  <div class="dropdown-menu custom" role="menu">
                    @can('Fuel edit')
                    <form action="{{ route('fuel.edit_fuel', $row->id) }}" method="GET">
                      @csrf
                      <input type="hidden" name="fleet_id" id="get_fleet_id" value="{{ $row->id }}">
