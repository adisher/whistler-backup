    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">Fleet &nbsp;
          @can('Vehicles add')<a href="{{ route('vehicle-types.create')}}" class="btn btn-success" title="@lang('fleet.addNew')"><i class="fa fa-plus"></i></a></h3>@endcan
      </div>
      ...
      <div class="card-body table-responsive">
        <table class="table" id="ajax_data_table">
          ...
          <tfoot>
            <tr>
              <th>
                @can('Vehicles delete')<button class="btn btn-danger" id="bulk_delete" data-toggle="modal" data-target="#bulkModal" disabled title="@lang('fleet.delete')" ><i class="fa fa-trash"></i></button>@endcan
              </th>
              <th>Make</th>
              <th>Model</th>
              <th>Type</th>
