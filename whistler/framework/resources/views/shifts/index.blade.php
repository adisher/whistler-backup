    ...
    <div class="col-md-12">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Manage Shifts &nbsp; @can('ProductYields add')
                    {{-- <a href="{{ route('shifts.create') }}" class="btn btn-success" title="@lang('fleet.addNew')"><i
