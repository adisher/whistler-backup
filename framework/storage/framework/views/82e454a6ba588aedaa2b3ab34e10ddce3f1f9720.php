        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><input type="checkbox" name="<?php echo e($row.' list'); ?>" value="1" class="flat-red form-control"></td>
              <?php else: ?>
              <td></td>
              <?php endif; ?>

              <?php if(!in_array($row,["Inquiries","Reports","Settings"])): ?>
              <td><input type="checkbox" name="<?php echo e($row.' add'); ?>" value="1" class="flat-red form-control"></td>
              <?php else: ?>
              <td></td>
              <?php endif; ?>

              <?php if(!in_array($row,["Inquiries","Reports","Transactions","ServiceReminders","Settings"])): ?>
              <td><input type="checkbox" name="<?php echo e($row.' edit'); ?>" value="1" class="flat-red form-control"></td>
              <?php else: ?>
              <td></td>
              <?php endif; ?>

              <?php if(!in_array($row,["Inquiries","Reports","Settings"])): ?>
              <td><input type="checkbox" name="<?php echo e($row.' delete'); ?>" value="1" class="flat-red form-control"></td>
              <?php else: ?>
              <td></td>
              <?php endif; ?>

              <?php if(in_array($row,["Drivers","Customer","Vendors"])): ?>
              <td><input type="checkbox" name="<?php echo e($row.' import'); ?>" value="1" class="flat-red form-control"></td>
              <?php else: ?>
              <td></td>
              <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/whistler/framework/resources/views/roles/create.blade.php ENDPATH**/ ?>