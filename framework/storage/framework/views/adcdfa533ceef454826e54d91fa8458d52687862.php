  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">
          <?php echo app('translator')->get('fleet.manageFuel'); ?>
          &nbsp;
          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Fuel add')): ?><a href="<?php echo e(route('fuel.add_fuel_form')); ?>" class="btn btn-success"  title="<?php echo app('translator')->get('fleet.addNew'); ?>"><i class="fa fa-plus"></i></a><?php endif; ?>
        </h3>
      </div>
        ...
        <table class="table" id="data_table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td> <?php echo e($row->qty); ?> Liter </td>
              <td>
                <?php ($total = $row->qty * $row->cost_per_unit); ?>
                <?php echo e($currency->symbol); ?><?php echo e($row->cost_per_unit); ?>/ Ltr
                <br>
                <b>Total:</b> <?php echo e($currency->symbol); ?><?php echo e($total); ?>
              ...
              <td>
                <div class="btn-group">
                  ...
                  <div class="dropdown-menu custom" role="menu">
                    ...
                    <form action="<?php echo e(route('fuel.edit_fuel', $row->id)); ?>" method="GET">
                      <?php echo csrf_field(); ?>
                      <input type="hidden" name="fleet_id" id="get_fleet_id" value="<?php echo e($row->id); ?>">
                ...
                'admin/fuel/destroy-fuel/'.$row->id,'method'=>'DELETE','class'=>'form-horizontal','id'=>'form_'.$row->id]); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/whistler/framework/resources/views/fuel/fueltable.blade.php ENDPATH**/ ?>