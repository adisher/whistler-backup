            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">Manage Sites &nbsp; <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ProductYields add')): ?>
                            <a href="<?php echo e(route('sites.create')); ?>" class="btn btn-success" title="<?php echo app('translator')->get('fleet.addNew'); ?>"><i
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/whistler/framework/resources/views/sites/index.blade.php ENDPATH**/ ?>