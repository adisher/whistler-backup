...
Route::namespace ('Admin')->group(function () {
    ...
    Route::group(['middleware' => ['lang_check', 'auth', 'officeadmin', 'IsInstalled']], function () {
        ...
        // get data by fleet type
        Route::get('vehicle-data-by-type/{type_id}', 'VehicleTypeController@getByType')->name('vehicle-data-by-type');
        ...
        Route::resource('shift-details', ShiftDetailsController::class);
        Route::get('fuel/fuel-details', 'FuelController@fuel_table')->name('fuel.fuel_details'); //custom route for view fuel details
        Route::get('fuel/fuel-form', 'FuelController@add_fuel_form')->name('fuel.add_fuel_form'); //custom route to add fuel (view)
        Route::post('fuel/add-fuel', 'FuelController@add_fuel')->name('fuel.add_fuel'); //custom route to add fuel
        Route::get('fuel/edit-fuel/{id}/edit-fuel', 'FuelController@edit_fuel')->name('fuel.edit_fuel'); //custom route to edit fuel (view)
        Route::patch('fuel/update-fuel/{fuel}', 'FuelController@update_fuel')->name('fuel.update_fuel'); //custom route to edit fuel
        Route::delete('fuel/destroy-fuel/{fuel}', 'FuelController@destroy_fuel')->name('fuel.destroy_fuel'); //custom route to edit fuel
        // Route::get('/fuel/allocate', 'FuelController@allocate')->name('fuel.allocate');
        Route::post('fuel/get-fuel-capacity', 'FuelController@get_fuel_capacity')->name('fuel.get_fuel_capacity'); //custom route to get fuel capacity
        Route::resource('sites', SiteController::class);
        Route::put('/products/approve/{id}', 'SiteController@approve')->name("sites.approve");
        ...
        Route::post('products-fetch', 'SiteController@fetch_data');
        Route::post('shifts-fetch', 'ShiftController@fetch_data');
        Route::post('shift-details-fetch', 'ShiftDetailsController@fetch_data');
        Route::post('maintenance-fetch', 'CorrectiveMaintenanceController@fetch_data');
        ...
        Route::get('get-open-shift/{id}', 'ShiftDetailsController@get_open_shift')->name('get_open_shift');
        Route::post('close-shift', 'WorkOrdersController@close_shift')->name('close_shift');
        ...
        Route::post('reports/download', 'ReportsController@download')->name('reports.download');
        Route::get('reports/scheduled', 'ReportsController@scheduled');
        Route::get('reports/templates', 'ReportsController@templates')->name('reports.template');
        Route::get('reports/generate', 'ReportsController@form')->name('reports.generate');
        Route::get('reports/get-fleet', 'ReportsController@get_fleet')->name('reports.get_fleet');
        Route::post('reports/fleet-data', 'ReportsController@fleet_data')->name('reports.fleet_data');
        Route::get('reports/get-fuel', 'ReportsController@get_fuel')->name('reports.get_fuel');
        
        Route::get('reports/get-parts', 'ReportsController@get_parts')->name('reports.get_parts');
        Route::get('reports/get-sites', 'ReportsController@get_sites')->name('reports.get_sites');
        ...
        Route::post('assignSite', 'VehiclesController@assign_site');
        ...
        Route::post("/reports/fuel", "ReportsController@fuel_post")->name("reports.fuel_report");
        Route::get("/reports/fuel", "ReportsController@fuel")->name("reports.fuel");
        Route::get("/reports/product-yield", "ReportsController@yield")->name("reports.yield");
        Route::post("/reports/product-yield", "ReportsController@yield_post")->name("reports.yield_report");
        Route::get("/reports/fleet", "ReportsController@fleet")->name("reports.fleet");
        Route::post("/reports/fleet", "ReportsController@fleet_post")->name("reports.fleet_report");
...
//report work order
        ...
        Route::get("/get-deployed-fleet", "ReportsController@get_deployed_fleet")->name("reports.deployed_fleet");
