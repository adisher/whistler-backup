    ...
    <div class="card card-success">
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('first_name', __('fleet.firstname') . ' <span class="text-danger">*</span>', ['class' => 'form-label
              required'], false) !!}
          ...
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('last_name', __('fleet.lastname') . ' <span class="text-danger">*</span>', ['class' => 'form-label required'], false) !!}
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
                {!! Form::hidden('email', 'driver@email.com',['class' => 'form-control']) !!}
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('phone', __('fleet.phone'). ' <span class="text-danger">*</span>', ['class' => 'form-label required'], false) !!}
              <div class="input-group">
                <div class="input-group-prepend">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              {!! Form::text('emp_id', 'WD-' . str_pad(rand(0,9999), 4, '0', STR_PAD_LEFT),['class' => 'form-control','required']) !!}
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('contract_number', __('Insurance Number'), ['class' => 'form-label']) !!}
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('license_number', __('fleet.licenseNumber'). ' <span class="text-danger">*</span>', ['class' => 'form-label required'], false) !!}
          ...
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('issue_date', __('License Issue Date'). ' <span class="text-danger">*</span>', ['class' => 'form-label'], false) !!}
          ...
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('exp_date', __('License Expiry Date'). ' <span class="text-danger">*</span>', ['class' => 'form-label required'], false) !!}
              <div class="input-group date">
                <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-calendar"></i></span>
                </div>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('start_date', __('fleet.join_date'). ' <span class="text-danger">*</span>', ['class' => 'form-label'], false) !!}
              <div class="input-group date">
                <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-calendar"></i></span>
                </div>
          ...
          <div class="col-md-4">
            <div class="form-group">
                {!! Form::input('hidden', 'password', '12345678', ['class' => 'form-control','required']) !!}
            </div>
          </div>
        </div>
        <div class="row">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              {!! Form::label('gender', __('fleet.gender'). ' <span class="text-danger">*</span>' , ['class' => 'form-label'], false) !!}<br>
          ...
          <div class="col-md-6">
            <div class="form-group">
              {!! Form::label('econtact', __('Other Details'), ['class' => 'form-label']) !!}
