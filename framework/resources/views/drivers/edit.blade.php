    ...
    <div class="card card-warning">
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('first_name', __('fleet.firstname'). ' <span class="text-danger">*</span>', ['class' => 'form-label required'], false) !!}
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('emp_id', __('fleet.employee_id'). ' <span class="text-danger">*</span>', ['class' => 'form-label'], false) !!}
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('issue_date', __('fleet.issueDate'). ' <span class="text-danger">*</span>', ['class' => 'form-label'], false) !!}
          ...
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('exp_date', __('fleet.expirationDate'). ' <span class="text-danger">*</span>', ['class' => 'form-label required'], false) !!}
              <div class="input-group date">
                <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-calendar"></i></span>
                </div>
