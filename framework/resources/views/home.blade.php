...
<div class="row">
    ...
    {{-- <div class="col-md-6">
        <div class="card">
            <div class="card-header d-flex align-items-center">
                <i class="fas fa-chevron-down mr-2" data-toggle="collapse" data-target="#daily-yield"></i>
                <h5 class="card-title mb-0">Daily Yield Production</h5>
            </div>
            <div class="card-body collapse show" id="daily-yield">
                <div class="chart">
                    <canvas id="dailyProduction" width="800" height="400"></canvas>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="card">
            <div class="card-header d-flex align-items-center">
                <i class="fas fa-chevron-down mr-2" data-toggle="collapse" data-target="#weekly-yield"></i>
                <h5 class="card-title mb-0">Weekly Yield Production</h5>
            </div>
            <div class="card-body collapse show" id="weekly-yield">
                <div class="chart">
                    <canvas id="weeklyProduction" width="800" height="400"></canvas>
                </div>
            </div>
        </div>
    </div> --}}
    ...
    // Function to toggle icons
        ...
        function handleYearChange() {
            $("#year").on("change", function() {
                var year = this.value;
                window.location = "{{ url('admin/') }}" + "?year=" + year;
            });
        }
