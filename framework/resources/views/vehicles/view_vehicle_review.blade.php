...
@endsection
@section("breadcrumb")
<li class="breadcrumb-item"><a href="{{ url('admin/vehicle-reviews')}}">@lang('Fleet Inspection')</a></li>
<li class="breadcrumb-item active">@lang('View Fleet Inspection')</li>
@endsection
  ...
  <div class="col-md-12">
    <div class="card card-success">
      <div class="card-header">
        <h3 class="card-title">@lang('Fleet Inspection') : {{$review->vehicle->makeModel->make}} - {{$review->vehicle->makeModel->model}} - {{$review->vehicle->license_plate}}&nbsp; <a href="{{url('admin/print-vehicle-review/'.$review->id)}}" class="btn btn-danger"><i class="fa fa-print"></i>&nbsp; @lang('fleet.print')</a></h3>
      </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              {!! Form::label('vehicle_id',__('Fleet')." : ", ['class' => 'form-label']) !!}
              {{$review->vehicle->makeModel->make}} - {{$review->vehicle->makeModel->model}} - {{$review->vehicle->license_plate}}
            </div>
          </div>
        </div>
        <div class="row">
