@extends("layouts.app")
@section("breadcrumb")
<li class="breadcrumb-item active">@lang('Fleet Inspection')</li>
@endsection
@section('extra_css')
<style type="text/css">
  .checkbox, #chk_all{
  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">
        @lang('Fleet Inspection')
        &nbsp;
        @can('VehicleInspection add')<a href="{{ url('admin/vehicle-reviews-create')}}" class="btn btn-success" title="@lang('Add Fleet Inspection')"><i class="fa fa-plus"></i></a>@endcan</h3>
      </div>
        ...
        <table class="table" id="ajax_data_table" style="padding-bottom: 25px">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
              @if($r->vehicle && $r->vehicle->vehicleData)
              {{$r->vehicle->vehicleData->make}} - {{$r->vehicle->vehicleData->model}} - {{ $r->vehicle->year }}
              @else
