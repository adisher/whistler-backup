<div class="btn-group">
    ...
    @can('Vehicles edit')<a class="dropdown-item" href="{{url("admin/vehicle-types/".$row->id."/edit") }}"> <span aria-hidden="true" class="fa fa-edit" style="color: #f0ad4e;"></span> @lang('fleet.edit')</a>@endcan
