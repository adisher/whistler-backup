            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">Corrective Maintenance &nbsp;
                        @can('Users add')
                            <a href="{{ route('maintenance.create') }}" class="btn btn-success" title="Corrective Maintenance"><i
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            var table = $('#ajax_data_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ url('admin/maintenance-fetch') }}",
                    type: 'POST',
                    data: {}
                },
                columns: [{
                    ...
                    {
                        data: 'vehicle_id',
                        name: 'corrective_maintenance.vehicle_id'
                    },
                    {
                        data: 'subject',
                        name: 'corrective_maintenance.subject'
                    },
                    {
                        data: 'meter',
                        name: 'corrective_maintenance.meter'
                    },
                    {
                        data: 'parts_id',
                        name: 'corrective_maintenance.parts_id'
                    },
                    {
                        data: 'quantity',
                        name: 'corrective_maintenance.quantity'
                    },
                    {
                        data: 'price',
                        name: 'corrective_maintenance.price'
                    },
                    {
                        data: 'description',
                        name: 'corrective_maintenance.description'
                    },
                    {
                        data: 'date',
                        name: 'corrective_maintenance.date'
                    },
                    {
                        data: 'action',
                        name: 'action',
