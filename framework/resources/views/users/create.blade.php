        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              {!! Form::label('first_name', __('fleet.firstname'). ' <span class="text-danger">*</span>', ['class' => 'form-label'], false) !!}
              {!! Form::text('first_name', null,['class' => 'form-control','required']) !!}
            </div>

            <div class="form-group">
              {!! Form::label('last_name', __('fleet.lastname'). ' <span class="text-danger">*</span>', ['class' => 'form-label'], false) !!}
              {!! Form::text('last_name', null,['class' => 'form-control','required']) !!}
            </div>

            <div class="form-group">
              {!! Form::label('role_id',__('fleet.role'). ' <span class="text-danger">*</span>', ['class' => 'form-label'], false) !!}
          ...
          <div class="col-md-6">
            <div class="form-group">
              {!! Form::label('email', __('fleet.email'). ' <span class="text-danger">*</span>', ['class' => 'form-label'], false) !!}
            ...
            <div class="form-group">
              {!! Form::label('password', __('fleet.password'). ' <span class="text-danger">*</span>', ['class' => 'form-label'], false) !!}
              <div class="input-group mb-3">
                <div class="input-group-prepend">
